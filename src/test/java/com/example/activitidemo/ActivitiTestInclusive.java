...
public class ActivitiTestInclusive {
   /* key-->  "leaveApplication" 是 xml文件定义的process id
      <process id="leaveApplication" name="出差流程定义" isExecutable="true">*/
    String key = "leaveProcessInclusive";
   public static String instanceId;
    ...
    public static void setInstanceId(String instanceId) {
        ActivitiTestInclusive.instanceId = instanceId;
    }
    ...
    */
    ...
    public void testDeploy(){
        ...
        Deployment deploy =  repositoryService.createDeployment()
                .addClasspathResource("bpmn/leaveProcessInclusive.bpmn20.xml").name("出差申请审批流程并行网关").deploy();
    ...
    */
    ...
    public void testStartProcess(){
        ...
        map.put("assignee4","熬夜波比");

        /*
         map 则是为其启动之后的流程实例赋值*/
        /*
        启动流程时，分别指定各个任务的负责人，上述代码表示该出差流程是由提莫发起的，审批人是维迦
...
/*通过 TaskService 进行查询，分别通过出差流程的 key 和用户名称，查询该用户名下的所有任务*/
...
//        List<Task> taskList = taskService.createTaskQuery().processInstanceId(getInstanceId()).list();
        for (Task task:taskList){
            ...
            System.out.println("出差人："+taskService.getVariable(taskId,"leaveUser"));
            ...
            System.out.println("出差理由："+taskService.getVariable(taskId,"reason"));
...
public void managerApprove() {
    ...
    public void hrApprove() {
        ...
        for (Task task : taskList) {
            ...
            System.out.println("当前流程变量: " + currentVariables);
            taskService.complete(task.getId(), currentVariables);
            System.out.println("人事审批完成...");
        }
    }
    @Test
    public void bossApprove() {
        String assignee = "熬夜波比";
